...
.login-container { max-width: 480px; margin: 0 auto; padding: 10px 20px; text-align: center; }
.network-container { position: relative; width: 340px; height: 260px; margin: 0 auto 20px auto; }
.node-center { position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); background: linear-gradient(135deg, #092543 0%, #103B66 100%); border-radius: 50%; width: 120px; height: 120px; display: flex; flex-direction: column; justify-content: center; align-items: center; font-weight: 900; color: #00D2FF; font-size: 24px; border: 3px solid #00D2FF; box-shadow: 0 0 25px rgba(0,210,255,0.5); z-index: 10; }
.node-center span { font-size: 12px; font-weight: 800; color: #8AB4F8; margin-top: 0px; letter-spacing: 0.5px; }
.node-sat { position: absolute; background-color: #06182B; border-radius: 50%; width: 70px; height: 70px; display: flex; justify-content: center; align-items: center; font-size: 16px; font-weight: 900; color: #FFFFFF; border: 2px solid #1A446F; box-shadow: 0 6px 15px rgba(0,0,0,0.6); z-index: 5; }
...
.pct-badge { position: absolute; top: 15px; right: -65px; color: #00D2FF; font-size: 24px; font-weight: 900; text-align: left; line-height: 1.1; }
...
.dt-title { font-size: 18px; letter-spacing: 3px; color: #8AB4F8; margin-bottom: 5px; font-weight: bold; }
.main-brand { font-size: 54px; font-weight: 950; color: #FFFFFF; margin-bottom: 5px; line-height: 1; }
.sub-brand { font-size: 14px; letter-spacing: 3px; color: #00D2FF; font-weight: bold; margin-bottom: 20px; }
.slogan { font-style: italic; color: #D1E2F4; font-size: 16px; margin-bottom: 25px; font-weight: 500; }
.tags-footer { font-size: 14px !important; color: #6C8EB4 !important; letter-spacing: 1px !important; font-weight: 700 !important; margin-bottom: 30px; }
.login-card { background-color: #06182B !important; padding: 35px 30px !important; border-radius: 16px !important; border: 1px solid #103154 !important; box-shadow: 0 12px 40px rgba(0,0,0,0.6) !important; text-align: left !important; }
.login-title { font-size: 28px !important; font-weight: 800 !important; color: #FFFFFF !important; text-align: center !important; margin-bottom: 5px !important; }
.login-subtitle { font-size: 15px !important; color: #8AB4F8 !important; text-align: center !important; margin-bottom: 25px !important; }
...
input[data-testid="stTextInputRootElement"], input { background-color: transparent !important; color: #FFFFFF !important; font-weight: 600 !important; font-size: 17px !important; }
input::placeholder { color: #5F82A8 !important; font-size: 15px !important; }
label { color: #8AB4F8 !important; font-weight: 700 !important; font-size: 16px !important; margin-bottom: 6px !important; display: block !important; }
div[data-testid="stForm"] { border: none !important; padding: 0 !important; }
button[data-testid="baseButton-secondaryFormSubmit"], button[data-testid="baseButton-secondary"] { background-color: #104A7E !important; color: white !important; border-radius: 12px !important; border: 1px solid #1A62A3 !important; font-weight: 800 !important; font-size: 17px !important; height: 52px !important; margin-top: 15px !important; box-shadow: 0 4px 15px rgba(16,74,126,0.4) !important; }
...
.resort-badge { background: #0A1E33; padding: 6px 14px; border-radius: 12px; font-weight: bold; font-size: 13px; border: 1px solid #143A63; color: #FFFFFF; }
.verified-badge { background: rgba(0,210,255,0.08); color: #00D2FF; padding: 6px 14px; border-radius: 12px; font-size: 12px; border: 1px solid rgba(0,210,255,0.2); font-weight: 600; }
...
# Estruturação em contêiner único centralizado (elimina transbordo lateral)
st.markdown('<div class="login-container">', unsafe_allow_html=True)

# 1. REDE DE ATIVOS NO TOPO CENTRAL
html_net = '<div class="network-container"><svg class="network-lines"><line x1="45" y1="45" x2="295" y2="215" style="stroke:#1A446F; stroke-width:3" /><line x1="295" y1="45" x2="45" y2="215" style="stroke:#1A446F; stroke-width:3" /></svg><div class="node-sat node-top-left">BIM</div><div class="node-sat node-top-right">IA</div><div class="node-sat node-bot-left">IoT</div><div class="node-sat node-bot-right">O&M</div><div class="pct-badge">88%<br><span>SLA</span></div><div class="node-center">DT<br><span>Facilities</span></div></div>'
st.markdown(html_net, unsafe_allow_html=True)

# 2. IDENTIDADE DA MARCA CENTRALIZADA
...
# 3. FORMULÁRIO DE ACESSO COMPACTO NA BASE
