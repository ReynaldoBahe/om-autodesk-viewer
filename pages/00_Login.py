...
.node-sat { position: absolute; background-color: #06182B; border-radius: 50%; width: 68px; height: 68px; display: flex; justify-content: center; align-items: center; font-size: 15px; font-weight: 900; color: #FFFFFF; border: 2px solid #1A446F; box-shadow: 0 6px 15px rgba(0,0,0,0.4); z-index: 5; }
